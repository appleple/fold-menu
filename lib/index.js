...
var FoldMenu = /** @class */ (function () {
    ...
    FoldMenu.prototype.calc = function () {
        var _a = this.option, foldMenuClass = _a.foldMenuClass, foldMenuToggleClass = _a.foldMenuToggleClass, foldMenuText = _a.foldMenuText;
        ...
        while (utility_1.getOffset(foldMenu).left + foldMenu.offsetWidth > utility_1.getOffset(this.selector).left + parentWidth) {
            console.log();
    ...
    FoldMenu.prototype.appendMenu = function () {
        var _a = this.option, foldMenuClass = _a.foldMenuClass, foldMenuToggleClass = _a.foldMenuToggleClass, foldMenuListClass = _a.foldMenuListClass, foldMenuText = _a.foldMenuText, addToggleBtn = _a.addToggleBtn;
